...
describe('status helpers', () => {
  it('maps construction statuses to design-system tones', () => {
    expect(statusTone('on_track')).toBe('success');
    expect(statusTone('answered')).toBe('success');
    expect(statusTone('watch')).toBe('warning');
    expect(statusTone('open')).toBe('warning');
    expect(statusTone('at_risk')).toBe('danger');
  ...
  it('maps badge variants for status chips', () => {
    expect(badgeVariant('on_track')).toBe('success');
