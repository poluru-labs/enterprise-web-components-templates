...
export function renderSettings() {
  return `
    ${pageHeader({
      eyebrow: 'Workspace',
      title: 'Settings',
      lead: 'Company profile, density, and how Pulse behaves when the sidebar is closed.',
    })}
    <div class="row g-3">
      <div class="col-lg-6">
        ${sheet({
          ...
          body: `
            ...
            <eds-slider class="mt-3" id="health-floor" label="At-risk floor" min="50" max="80" value="65" show-value></eds-slider>
            <eds-switch class="mt-3" label="Start in full width" checked></eds-switch>
            <eds-switch class="mt-3" label="Friday QBR reminder" checked></eds-switch>`,
        })}
      </div>
      <div class="col-lg-6">
        ${sheet({
          ...
          body: `
            ...
            <p class="muted mt-3 mb-1">Jump to an account</p>
