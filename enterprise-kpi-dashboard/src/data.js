...
export const reviews = [
  { label: 'Weekly ops review', description: 'Rohan Poluru · Mondays 09:00', timestamp: '25 Aug', icon: 'clock' },
  { label: 'Growth forecast lock', description: 'Kavya Poluru · pipeline 3.4x', timestamp: '26 Aug', icon: 'star' },
  { label: 'Product 1.8 readout', description: 'Nikhil Poluru · adoption 23%', timestamp: '27 Aug', icon: 'file' },
  { label: 'Board pack freeze', description: 'Mira Poluru · Thursday 16:00', timestamp: '28 Aug', icon: 'check' },
  { label: 'Customer voice hour', description: 'Priya Poluru · NPS 62', timestamp: '29 Aug', icon: 'user' },
];
