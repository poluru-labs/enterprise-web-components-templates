...
export const currentUser = {
  name: 'Priya Menon',
  email: 'priya.menon@northshore.example',
...
export const navItems = [
  ...
  { label: 'Analytics', href: '#/analytics', icon: 'star' },
...
export const kpis = [
  ...
  { label: 'Outstanding', value: '$41.6K', hint: '12 open invoices', trend: 'down', trendValue: '-$6.2K' },
  ...
  { label: 'Active subscriptions', value: '312', hint: '18 on trial', trend: 'up', trendValue: '+14' },
...
export const invoiceTimeline = [
  ...
  { title: 'Viewed by customer', description: 'Meera Nair opened the hosted invoice', timestamp: '1 Aug · 11:40', status: 'complete' },
...
export const planCards = [
  { label: 'Starter', value: '64', hint: '$540 median · 6 trials', trend: 'up', trendValue: '+4' },
  { label: 'Growth', value: '128', hint: '$2,280 median', trend: 'up', trendValue: '+9' },
  { label: 'Scale', value: '81', hint: '$7,100 median', trend: 'flat', trendValue: '0' },
...
export const reports = [
  { name: 'Invoice aging', description: 'Open AR by 0–30 / 31–60 / 61–90 / 90+', owner: 'Priya Menon', updated: 'Today 07:10' },
  { name: 'Payment reconciliation', description: 'Gateway captures vs general ledger', owner: 'Arjun Desai', updated: 'Today 06:40' },
  { name: 'Subscription retention', description: 'Cohort logos and NRR by plan', owner: 'Meera Nair', updated: 'Yesterday' },
  { name: 'Tax summary', description: 'Sales tax and VAT collected by region', owner: 'Sahana Rao', updated: 'Monday' },
];

export const revenueMonths = [142, 148, 151, 158, 162, 169, 174, 179, 181, 184, 186, 186];
