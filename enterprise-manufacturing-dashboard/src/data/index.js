...
export const productLine = 'Security operations';
export const workspaceName = 'Threat command center';

export const currentUser = {
  name: 'Mira Poluru',
  email: 'mira.poluru@sentinel.example',
  role: 'Security administrator',
};

export const workspace = {
  name: workspaceName,
  period: 'Live · 11 Sep 2026',
  timezone: 'UTC / Chicago',
  close: 'Next review 14 Sep 2026',
};

export const tickerItems = [
  { label: 'Open incidents', value: '02', delta: '1 critical', trend: 'down', href: '#/alerts' },
  { label: 'Active alerts', value: '18', delta: '6 triage', trend: 'flat', href: '#/alerts' },
  { label: 'Risk exposure', value: '8.4', delta: '−12%', trend: 'up', href: '#/trends' },
  { label: 'Coverage', value: '87%', delta: '+4.2%', trend: 'up', href: '#/scorecards' },
  { label: 'MTTR', value: '42m', delta: '−18m', trend: 'up', href: '#/reviews' },
];

export const navItems = [
  { label: 'Command center', href: '#/overview', icon: 'grid' },
  { label: 'Incidents', href: '#/alerts', icon: 'exclamation-triangle' },
  { label: 'Alerts', href: '#/scorecards', icon: 'bell' },
  { label: 'Vulnerabilities', href: '#/goals', icon: 'bug' },
  { label: 'Investigations', href: '#/trends', icon: 'search' },
  { label: 'Response playbooks', href: '#/teams', icon: 'lightning' },
  { label: 'Threat intel', href: '#/reviews', icon: 'binoculars' },
  { label: 'Reports', href: '#/reports', icon: 'file-earmark-bar-graph' },
