...
export function renderSettings() {
  return `
    ${pageHeader({
      eyebrow: 'Workspace',
      title: 'Settings',
      lead: 'City profile, density, and how CivicWorks behaves when the sidebar is closed.',
    })}
    <div class="row g-3">
      <div class="col-lg-6">
        ${sheet({
          ...
          body: `
            ...
            <eds-slider class="mt-3" id="sla-floor" label="311 SLA floor" min="80" max="98" value="90" show-value></eds-slider>
            <eds-switch class="mt-3" label="Start in full width" checked></eds-switch>
            <eds-switch class="mt-3" label="Same-day pickup ping" checked></eds-switch>`,
        })}
      </div>
      <div class="col-lg-6">
        ${sheet({
          ...
          body: `
            ...
            <p class="muted mt-3 mb-1">Jump to a request</p>
