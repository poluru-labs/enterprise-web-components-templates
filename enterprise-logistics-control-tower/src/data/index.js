export const productName = 'Meridian Logistics';
export const productLine = 'Control tower';
export const workspaceName = 'North America network';
...
export const workspace = {
  name: workspaceName,
  period: 'Network day · 11 Sep 2026',
  timezone: 'America / Chicago',
  close: 'Shift handoff at 18:00 CT',
};

export const tickerItems = [
  { label: 'Shipments', value: '2,486', delta: '+8.2%', trend: 'up', href: '#/overview' },
  { label: 'On-time', value: '94.8%', delta: '+1.6 pts', trend: 'up', href: '#/overview' },
  { label: 'At risk', value: '38', delta: '-12%', trend: 'up', href: '#/alerts' },
  { label: 'Carrier score', value: '91', delta: '+3 pts', trend: 'up', href: '#/overview' },
  { label: 'Dock queue', value: '17', delta: 'Watch', trend: 'flat', href: '#/overview' },
  { label: 'Network ETA', value: '96.2%', delta: 'Stable', trend: 'flat', href: '#/trends' },
];

export const navItems = [
  { label: 'Control tower', href: '#/overview', icon: 'home' },
  { label: 'Shipments', href: '#/shipments', icon: 'truck' },
  { label: 'Routes', href: '#/routes', icon: 'signpost' },
  { label: 'Carriers', href: '#/carriers', icon: 'people' },
  { label: 'Exceptions', href: '#/exceptions', icon: 'alert-triangle' },
  { label: 'Warehouses', href: '#/warehouses', icon: 'box' },
