...
describe('Harbor workspace',()=>{
 ...
 it('credits the author and design system in the footer',()=>{const footer=shell.querySelector('.main-footer');expect(footer.textContent).toContain('Created by');expect(footer.querySelector('a[href="https://polurus.com"]')?.textContent).toBe('Subrahmanyam Poluru');expect(footer.querySelector('a[href="https://www.npmjs.com/package/@poluru-labs/enterprise-design-system-wc"]')?.textContent).toBe('@poluru-labs/enterprise-design-system-wc');});
});
