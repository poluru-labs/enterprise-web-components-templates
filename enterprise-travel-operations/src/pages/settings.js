...
export function renderSettings() {
  return `
    ${pageHeader({
      eyebrow: 'Workspace',
      title: 'Settings',
      lead: 'Company profile, density, and how Waypoint behaves when the sidebar is closed.',
    })}
    <div class="row g-3">
      <div class="col-lg-6">
        ${sheet({
          ...
          body: `
            ...
            <eds-slider class="mt-3" id="checkin-floor" label="Check-in floor" min="80" max="100" value="90" show-value></eds-slider>
            <eds-switch class="mt-3" label="Start in full width" checked></eds-switch>
            <eds-switch class="mt-3" label="Eight-hour Lagos ping" checked></eds-switch>`,
        })}
      </div>
      <div class="col-lg-6">
        ${sheet({
          ...
          body: `
            ...
            <p class="muted mt-3 mb-1">Jump to a trip</p>
