    ...
    <section class="row g-3 mt-1">
      <div class="col-lg-8">
        <eds-card class="chart-card" elevated padded>
          ...
          <svg class="sparkline" viewBox="0 0 360 92" role="img" aria-label="Revenue trend for the last twelve weeks">
...
export function renderExplorer() {
  return `
    ${header('Lineage', 'Explorer', 'Navigate certified folders, preview SQL, and inspect schema.')}
    <div class="row g-3">
      <div class="col-lg-4">
        <eds-card elevated padded>
...
export function renderQuery() {
  return `
    ${header('Authoring', 'Query lab', 'Draft, validate, schedule, and publish a governed query.')}
...
export function renderSettings() {
  return `
    ${header('Administration', 'Settings', 'Workspace defaults, density, and account preferences.')}
...
export function renderLegal() {
  return `
    ${header('Governance', 'Legal & copyright', 'License, attribution, and demo-data notices for this template.')}
    <eds-card elevated padded>
