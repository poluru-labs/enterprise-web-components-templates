...
export const kpis = [
  ...
  { label: 'Inbound orders', value: '86', hint: '24 arriving today', trend: 'up', trendValue: '+12' },
  { label: 'Stock accuracy', value: '98.4%', hint: 'Cycle count vs. system', trend: 'up', trendValue: '+1.2 pts' },
  { label: 'Low stock alerts', value: '14', hint: '3 need attention today', trend: 'down', trendValue: '-4' },
  { label: 'Fulfillment rate', value: '96.7%', hint: 'Same-day dispatch', trend: 'up', trendValue: '+0.8 pts' },
  { label: 'Open POs', value: '32', hint: '$1.4M committed spend', trend: 'flat', trendValue: 'On plan' },
...
export const products = [
  { id: 'sku_001', sku: 'NB-1042', name: 'Cushioned trail runner', category: 'Footwear', warehouse: 'Chicago Central', quantity: 3240, reorder: 800, status: 'In stock', updated: '29 Aug 2026' },
  { id: 'sku_002', sku: 'NB-2071', name: 'Insulated steel bottle 750ml', category: 'Outdoor gear', warehouse: 'Dallas South', quantity: 540, reorder: 600, status: 'Low stock', updated: '29 Aug 2026' },
  { id: 'sku_003', sku: 'NB-3350', name: 'Packable rain shell', category: 'Apparel', warehouse: 'Atlanta East', quantity: 1890, reorder: 500, status: 'In stock', updated: '28 Aug 2026' },
  { id: 'sku_004', sku: 'NB-4108', name: 'Carbon trekking pole pair', category: 'Outdoor gear', warehouse: 'Denver West', quantity: 210, reorder: 300, status: 'Backordered', updated: '27 Aug 2026' },
  { id: 'sku_005', sku: 'NB-5223', name: 'Merino base layer', category: 'Apparel', warehouse: 'Chicago Central', quantity: 2760, reorder: 700, status: 'In stock', updated: '29 Aug 2026' },
  { id: 'sku_006', sku: 'NB-6019', name: '45L expedition backpack', category: 'Bags', warehouse: 'Seattle North', quantity: 430, reorder: 400, status: 'In stock', updated: '26 Aug 2026' },
  { id: 'sku_007', sku: 'NB-7304', name: 'LED headlamp 400 lumen', category: 'Electronics', warehouse: 'Dallas South', quantity: 95, reorder: 350, status: 'Low stock', updated: '29 Aug 2026' },
  { id: 'sku_008', sku: 'NB-8117', name: 'Compression dry bag set', category: 'Bags', warehouse: 'Atlanta East', quantity: 1620, reorder: 450, status: 'In stock', updated: '25 Aug 2026' },
];
...
export const alerts = [
  { id: 'a1', title: 'Insulated bottle below reorder point', owner: 'Meera Poluru', location: 'Dallas South', severity: 'Red', since: '29 Aug', note: '540 units on hand against a 600-unit reorder point.' },
  { id: 'a2', title: 'Headlamp stock critically low', owner: 'Meera Poluru', location: 'Dallas South', severity: 'Red', since: '29 Aug', note: '95 units on hand; supplier lead time is 11 days.' },
  { id: 'a3', title: 'Trekking poles backordered', owner: 'Ishita Poluru', location: 'Denver West', severity: 'Amber', since: '27 Aug', note: 'Ferrotech shipment delayed to 9 Sep.' },
  { id: 'a4', title: 'Seattle capacity above 85%', owner: 'Devansh Poluru', location: 'Seattle North', severity: 'Amber', since: '26 Aug', note: 'Overflow pallets moved to Phoenix Hub.' },
...
export const reviews = [
  { label: 'Weekly cycle count', description: 'Aditi Poluru · Mondays 08:00', timestamp: '25 Aug', icon: 'clock' },
  { label: 'Supplier scorecard review', description: 'Farhan Poluru · lead time trend', timestamp: '26 Aug', icon: 'star' },
  { label: 'Peak-season capacity plan', description: 'Devansh Poluru · Seattle overflow', timestamp: '27 Aug', icon: 'file' },
  { label: 'Reorder point audit', description: 'Simran Poluru · demand plan refresh', timestamp: '28 Aug', icon: 'check' },
  { label: 'Logistics ops sync', description: 'Yusuf Poluru · carrier performance', timestamp: '29 Aug', icon: 'user' },
];

export const reports = [
  { name: 'Weekly stock snapshot', owner: 'Aditi Poluru', updated: '29 Aug 2026', format: 'PDF' },
  { name: 'Reorder point export', owner: 'Simran Poluru', updated: '28 Aug 2026', format: 'CSV' },
  { name: 'Supplier scorecard', owner: 'Farhan Poluru', updated: '27 Aug 2026', format: 'XLSX' },
  { name: 'Warehouse capacity plan', owner: 'Devansh Poluru', updated: '26 Aug 2026', format: 'PDF' },
];

export const inboxItems = [
  { label: 'Two SKUs are below reorder point', description: 'Meera Poluru · Dallas South', icon: 'alert-triangle' },
  { label: 'Cycle count due Monday', description: 'Aditi Poluru · 08:00', icon: 'clock' },
  { label: 'Highline Textiles PO confirmed', description: 'Farhan Poluru · Procurement', icon: 'check' },
];
...
export const productHistoryRows = [
  { date: '29 Aug 2026', change: '-120', balance: '3,240', reason: 'Outbound fulfillment' },
  { date: '27 Aug 2026', change: '+600', balance: '3,360', reason: 'Purchase order received' },
  { date: '24 Aug 2026', change: '-85', balance: '2,760', reason: 'Outbound fulfillment' },
  { date: '20 Aug 2026', change: '-40', balance: '2,845', reason: 'Cycle count adjustment' },
];
