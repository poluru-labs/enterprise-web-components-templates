...
export const headerStages = [
  { label: 'Prospect', stage: 'Qualify' },
  { label: 'Qualified', stage: 'Discovery' },
  { label: 'Proposal', stage: 'Proposal' },
...
export const navGroups = [
  {
    ...
    items: [
      ...
      { label: 'Pipeline', href: '#/pipeline', icon: 'bi-kanban', badge: '10' },
      { label: 'Forecast', href: '#/forecast', icon: 'bi-graph-up-arrow', badge: '78%' },
      { label: 'Search', href: '#/search', icon: 'bi-search' },
    ],
  },
  {
    label: 'Records',
    items: [
      { label: 'Deals', href: '#/deals', icon: 'bi-briefcase', badge: '74' },
      { label: 'Leads', href: '#/leads', icon: 'bi-person-plus', badge: '14' },
  ...
  },
  {
    label: 'Work',
    items: [
      { label: 'Activities', href: '#/activities', icon: 'bi-calendar-check', badge: '8' },
...
export const kpis = [
  ...
  { label: 'Open deals', value: '74', hint: '16 closing this week', trend: 'up', trendValue: '+8' },
  { label: 'New leads', value: '412', hint: 'MQL conversion 24%', trend: 'up', trendValue: '+22.4%' },
  ...
  { label: 'Follow-ups', value: '32', hint: '8 due today', trend: 'flat', trendValue: 'On track' },
...
export const funnel = [
  { stage: 'Qualify', count: 20, width: 100, value: '$720k' },
  { stage: 'Discovery', count: 16, width: 82, value: '$580k' },
  { stage: 'Proposal', count: 12, width: 64, value: '$920k' },
  { stage: 'Negotiation', count: 8, width: 44, value: '$512k' },
  { stage: 'Closed won', count: 5, width: 28, value: '$368k' },
];
...
export const teamBoard = [
  ...
  { name: 'Rohan Poluru', closed: '$98k', pipeline: '$420k', quota: 48, trend: '+5%' },
];
...
export const agenda = [
  ...
  { id: 'ag_05', time: 'Mon 09:00', title: 'Cascade renewal review', with: 'Priya Poluru', type: 'Meeting' },
  { id: 'ag_06', time: 'Tue 11:30', title: 'Vertex pilot check-in', with: 'Vikram Poluru', type: 'Call' },
];
...
export const atRisk = [
  ...
  { account: 'Vertex Systems', owner: 'Jordan Poluru', reason: 'Security review stalled', value: '$118k', href: '#/deal/deal_vertex' },
];
...
export const contacts = [
  ...
  },
  {
    ...
    name: 'Priya Poluru',
    title: 'VP Data',
    account: 'Cascade Analytics',
    accountId: 'acc_cascade',
    email: 'priya.poluru@cascade.example',
    phone: '+1 650 555 0162',
    influence: 'Champion',
    last: 'Today',
  },
  {
    ...
    email: 'vikram.poluru@vertex.example',
...
export const deals = [
  ...
  {
    id: 'deal_cascade',
    name: 'Cascade enterprise renewal',
    account: 'Cascade Analytics',
    accountId: 'acc_cascade',
    value: '$156,000',
    amount: 156000,
...
export const leads = [
  ...
  { id: 'lead_07', name: 'Anika Poluru', company: 'Summit Forge', email: 'anika.poluru@summitforge.example', status: 'New', score: 85, source: 'Inbound', owner: 'Priya Poluru', created: '2026-08-28' },
  { id: 'lead_08', name: 'Dev Poluru', company: 'Helix Robotics', email: 'dev.poluru@helix.example', status: 'Working', score: 71, source: 'Partner', owner: 'Rohan Poluru', created: '2026-08-26' },
];
...
export const activities = [
  ...
  { id: 'act_07', type: 'Meeting', title: 'Cascade renewal review', with: 'Priya Poluru', when: 'Mon · 11:00', status: 'Scheduled', owner: 'Priya Poluru' },
  { id: 'act_08', type: 'Call', title: 'Vertex security walkthrough', with: 'Vikram Poluru', when: 'Tue · 15:30', status: 'Due today', owner: 'Jordan Poluru' },
];
...
export const activityFeed = [
  ...
  { title: 'Cascade renewal in commit', description: 'Priya Poluru · $156k · terms in review', timestamp: 'Today 08:10', status: 'current' },
];
...
export const reports = [
  ...
  { name: 'Forecast accuracy', description: 'Commit vs closed by week, FY26 Q3', owner: 'Priya Poluru', updated: 'Today 08:00' },
  { name: 'Partner sourced', description: 'Partner-influenced pipeline and win rate', owner: 'Sahana Poluru', updated: 'Friday' },
];
...
export const commandItems = [
  ...
  { label: 'Search records', description: 'Global CRM search', href: '#/search', icon: 'search' },
];
...
export const inboxItems = [
  ...
  { label: 'Vertex security review stalled', description: 'Vikram Poluru · 6 days · $118k', icon: 'alert-triangle' },
];

export const pinnedDeal = deals[0];

export function stageCounts() {
  return headerStages.map(({ label, stage }) => ({
    label,
    stage,
...
export function searchableRecords() {
  return [
    ...deals.map((d) => ({ type: 'Deal', name: d.name, detail: `${d.account} · ${d.value}`, href: `#/deal/${d.id}`, owner: d.owner })),
    ...accounts.map((a) => ({ type: 'Account', name: a.name, detail: `${a.industry} · ${a.owner}`, href: `#/account/${a.id}`, owner: a.owner })),
    ...contacts.map((c) => ({ type: 'Contact', name: c.name, detail: `${c.title} · ${c.account}`, href: `#/contact/${c.id}`, owner: c.account })),
    ...leads.map((l) => ({ type: 'Lead', name: l.name, detail: `${l.company} · score ${l.score}`, href: '#/leads', owner: l.owner })),
  ];
}
