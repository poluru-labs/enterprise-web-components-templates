...
export function renderReports() {
  return `
    ${pageHeader({
      eyebrow: 'Exports',
      title: 'Reports',
      lead: 'Check-in pack, sponsor book, speaker grid, room utilization, registration dump, and post-show appendix.',
    })}
    <div class="row g-3">
      <div class="col-lg-7">
      ...
      <div class="col-lg-5">
        ${sheet({
          ...
          body: `<eds-code-snippet id="api-snippet" language="json"></eds-code-snippet>
            <eds-file-upload class="mt-3" label="Upload a CSV import" accept=".csv,.xlsx" hint="Used for registrations and check-in loads."></eds-file-upload>`,
        })}
      </div>
    </div>
  `;
