...
export function renderSettings() {
  return `
    ${pageHeader({
      eyebrow: 'Workspace',
      title: 'Settings',
      lead: 'Hall profile, density, and how Gather behaves when the sidebar is closed.',
    })}
    <div class="row g-3">
      <div class="col-lg-6">
        ${sheet({
          ...
          body: `
            ...
            <eds-slider class="mt-3" id="fill-floor" label="Check-in floor" min="60" max="95" value="80" show-value></eds-slider>
            <eds-switch class="mt-3" label="Start in full width" checked></eds-switch>
            <eds-switch class="mt-3" label="Foyer lag ping" checked></eds-switch>`,
        })}
      </div>
      <div class="col-lg-6">
        ${sheet({
          ...
          body: `
            ...
            <p class="muted mt-3 mb-1">Jump to an event</p>
